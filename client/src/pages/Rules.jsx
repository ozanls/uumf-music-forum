function Rules() {
  ...
  return (
    <section>
      ...
      <p>
        Welcome to {forumName}! To ensure a positive experience for all users,
      ...
      <ul>
        <li>
          Treat all members with respect, regardless of their taste in music or
          opinions.
        </li>
        <li>No personal attacks, insults, or harassment of any kind.</li>
        <li>Disagreements should be expressed politely and constructively.</li>
      </ul>
      ...
      <ul>
        ...
        <li>
          No spam, advertisements, or self-promotion without prior approval from
          moderators.
        </li>
      ...
      <ul>
        <li>
          Respect copyright laws. Do not share illegal downloads or unauthorized
          streaming links.
        </li>
        <li>
      ...
      <ul>
        <li>
          One account per user. Multiple accounts (sockpuppets) are not allowed.
        </li>
        <li>
          Choose an appropriate username. Offensive or misleading usernames are
          prohibited.
        </li>
      ...
      <ul>
        <li>
          Moderator decisions are final. Do not argue with moderators in public
          threads.
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          Discussions of mature themes must be properly tagged and should not be
          gratuitous.
        </li>
      </ul>
      ...
      <ul>
        <li>
          English is the primary language of the forum. Use other languages only
          in designated areas.
        </li>
