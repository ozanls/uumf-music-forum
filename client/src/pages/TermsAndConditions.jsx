  ...
  return (
    <main>
      ...
      <p>
        ...
        website (the "Service") operated by {companyName} ("us", "we", or
        "our").
      </p>
      ...
      <p>
        ...
        years old. If you are under 16 years old, you may not use or access the
      ...
      <p>
        ...
        property of {companyName} and its licensors. The Service is protected by
        copyright, trademark, and other laws of both Canada and foreign
      ...
      <p>
        ...
        posted on the Service. We may, in our sole discretion, delete, move, or
        edit any Content that violates these Terms or that we otherwise find
        objectionable.
      </p>
